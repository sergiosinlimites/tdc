...
fprintf(fid, ['Con la iteracion de pesos especificos para phi, Hinf ya no ', ...
    ...
    'mantiene menor RMS lateral. Si se exige aprobar sin ese flag, la ', ...
    'siguiente iteracion debe enfocarse en rechazo de ruido/perturbacion ', ...
    'lateral o en un Hinf MIMO; el precompensador de referencia ya no es ', ...
